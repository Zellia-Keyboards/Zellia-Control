...
export const translations = {
  en: {
    ...
    'performance.rapidTrigger': 'Rapid Trigger',
    ...
    'performance.continuousRapidTriggerDesc': 'Maintain rapid trigger state continuously.',
    'performance.sensitivity': 'Sensitivity',
    'performance.separateSensitivity': 'Separate Press/Release Sensitivity',
    'performance.pressSensitivity': 'Press Sensitivity',
    'performance.releaseSensitivity': 'Release Sensitivity',
    ...
    'performance.continuousRapidTriggerFullDesc':
    ...
    'advancedkey.neutralDesc': 'Both keys are released when conflicting',
    ...
    'advancedkey.rapidTriggerDesc':
      'Enable Rapid Trigger to resolve key events only when Rapid Trigger registers the key press. Adjust the sensitivity below.',
    'advancedkey.actuationPointDesc': 'Set the distance at which the key press is registered.',
    'advancedkey.keySensitivityWarning':
      'the key may be too sensitive, causing instability, please be careful',
    'advancedkey.directInput': 'Direct input:',
    'advancedkey.rapidTriggerDownSensitivity': 'Rapid Trigger Down Sensitivity',
    'advancedkey.rapidTriggerDownSensitivityDesc':
      'Set how sensitive the rapid trigger should be on key press.',
    ...
    'advancedkey.pairedWith': 'Paired With:',
    ...
    'advancedkey.tap': 'Tap',
    'advancedkey.preview': 'Preview',
    'advancedkey.testKeyDesc': 'Test your key configuration by pressing the selected key',
    'advancedkey.resetAllDynamic': 'Reset All Dynamic Keys',
    ...
    'advancedkey.sensitivityWarning':
      'the key may be too sensitive, causing instability, please be careful',
    ...
    'advancedkey.exportConfig': 'Export Configuration',
    'advancedkey.importConfig': 'Import Configuration',
    ...
    'advancedkey.tapHoldDescription':
      'Perfect for modifier keys that can also function as regular keys when tapped quickly.', // Calibration Page
    ...
    'calibration.calibrationResults':
      'Calibration Complete! Rest: {0}mm, Pressed: {1}mm, Travel: {2}mm',
    ...
    'ui.displayTooSmallDesc':
      'Zellia Control requires a larger display for the optimal keyboard configuration experience. Please use a desktop or laptop computer, or expand your browser window.',
    ...
    'calibration.deviceSettingsDesc':
      "Device settings allow you to manage your keyboard's operational state. Choose actions carefully, especially factory reset which cannot be undone.",
    ...
    'update.subtitle': 'Keep your keyboard up to date with the latest features',
    'update.checkUpdates': 'Check Updates',
    'update.updatesAvailable': 'Updates Available',
    'update.componentNeedsUpdate': 'component needs updating',
    'update.componentsNeedUpdate': 'components need updating',
    'update.updateFirmware': 'Update Firmware',
    'update.masterMcu': 'Master MCU',
    'update.masterMcuDesc': 'AT32F405 • Controls all firmware updates',
    'update.systemVersion': 'System v{0} → v{1}',
    'update.ready': 'Ready',
    'update.updatingSystem': 'Updating System...',
    'update.systemUpdated': 'System Updated',
    ...
    'update.awaitingMasterUpdate': 'Awaiting Master MCU update',
    'update.advancedOptions': 'Advanced Options',
    'update.forceUpdate': 'Force Update',
    'update.forceUpdateDesc': 'Force update all components for recovery',
    'update.bootloaderMode': 'Bootloader Mode',
    'update.bootloaderModeDesc': 'Enter bootloader for manual flashing',
    'update.hideAdvancedOptions': 'Hide Advanced Options',
    'update.showAdvancedOptions': 'Show Advanced Options',
    ...
    'welcome.features.performance': 'Performance',
    'welcome.features.performanceDesc': 'Fine-tune actuation and rapid trigger',
    'welcome.features.lighting': 'RGB Lighting',
    'welcome.features.lightingDesc': 'Create stunning lighting effects',
    ...
    'demo.zellia60.description': 'Compact 60% layout perfect for gaming and minimalist setups.',
    'demo.zellia80.description': 'Tenkeyless layout with function keys for balanced productivity.',
    'demo.features.compact': 'Compact Design',
    'demo.features.fullFunction': 'Full Function Keys',
    'demo.features.hallEffect': 'Hall Effect Switches',
  ...
  zh: {
    ...
    'ui.displayTooSmallDesc':
      'Zellia 控制需要更大的显示器来获得最佳的键盘配置体验。请使用台式机或笔记本电脑，或扩展您的浏览器窗口。',
    ...
    'performance.continuousRapidTriggerFullDesc':
      '启用时，快速触发在整个按键释放时结束。禁用时，快速触发在触发点结束。',
    ...
    'debug.recoveryModeDesc':
      '将设备重启到恢复模式。通常情况下，您不需要使用此功能。如果误触发，只需重新连接设备即可恢复。',
    ...
    'calibration.deviceSettingsDesc':
      '设备设置允许您管理键盘的运行状态。请谨慎选择操作，特别是恢复出厂设置无法撤销。',
    ...
    'lighting.noColorSettings': '此效果不需要颜色设置',
    ...
    'remap.basicKeys': '基础按键',
    'remap.functionKeys': '功能键',
    'remap.mediaKeys': '媒体键',
    'remap.mouse': '鼠标',
    'remap.alphabet': '字母',
    'remap.numbers': '数字',
    'remap.specialCharacters': '特殊字符',
    'remap.mouseFunctions': '鼠标功能',
    ...
    'advancedkey.infoDesc':
      '高级按键配置允许您自定义单个按键的行为，超越标准打字。每种模式都提供独特的功能来增强您的键盘体验。',
    ...
    'advancedkey.neutralDesc': '冲突时两个按键都释放',
    ...
    'advancedkey.selectTwoKeysDesc':
      '在键盘布局中点击两个相对的按键来配置空绑定行为。按键将自动添加。',
    ...
    'advancedkey.alternativeBottomOutBehaviorDesc':
      '当两个按键都到底时，为两个按键都注册按键事件。',
    'advancedkey.bottomOutPointDesc': '设置按键到底的距离。',
    'advancedkey.rapidTriggerDesc':
      '启用快速触发以仅在快速触发注册按键事件时解决按键事件。在下方调整灵敏度。',
    ...
    'advancedkey.testKeyDesc': '通过按下选中的按键测试您的按键配置',
    'advancedkey.resetAllDynamic': '重置所有动态按键',
    ...
    'advancedkey.sensitivityWarning': '按键可能过于敏感，导致不稳定，请小心使用',
    ...
    // Update Page
    'update.title': '固件更新',
    'update.subtitle': '保持您的键盘更新到最新功能',
    'update.checkUpdates': '检查更新',
    'update.updatesAvailable': '可用更新',
    'update.componentNeedsUpdate': '个组件需要更新',
    'update.componentsNeedUpdate': '个组件需要更新',
    'update.updateFirmware': '更新固件',
    'update.masterMcu': '主MCU',
    'update.masterMcuDesc': 'AT32F405 • 控制所有固件更新',
    'update.systemVersion': '系统 v{0} → v{1}',
    'update.ready': '就绪',
    'update.updatingSystem': '正在更新系统...',
    'update.systemUpdated': '系统已更新',
    'update.checking': '检查中...',
    'update.error': '错误',
    'update.updateSystem': '更新系统',
    'update.masterMcuProgress': '主MCU更新进度',
    'update.connectedMcuNote': '主MCU完成后，连接的MCU将自动更新',
    'update.beingUpdatedByMaster': '正由主MCU更新',
    'update.updatedByMaster': '✓ 已由主MCU更新',
    'update.latestVersion': '最新版本',
    'update.awaitingMasterUpdate': '等待主MCU更新',
    'update.advancedOptions': '高级选项',
    'update.forceUpdate': '强制更新',
    'update.forceUpdateDesc': '强制更新所有组件以进行恢复',
    'update.bootloaderMode': '引导程序模式',
    'update.bootloaderModeDesc': '进入引导程序进行手动烧录',
    'update.hideAdvancedOptions': '隐藏高级选项',
    ...
    // Welcome page
    'welcome.title': 'Zellia Control',
    'welcome.subtitle': '连接您的键盘或尝试演示模式',
    'welcome.connectKeyboard': '连接键盘',
    'welcome.connectDescription': '连接您的 Zellia 键盘开始配置',
    ...
    'welcome.features.keymapping': '按键映射',
    'welcome.features.keymappingDesc': '根据您的喜好自定义每个按键',
    'welcome.features.performance': '性能',
    'welcome.features.performanceDesc': '微调触发和快速触发',
    'welcome.features.lighting': 'RGB 灯光',
    'welcome.features.lightingDesc': '创造令人惊叹的灯光效果',

    // Demo mode
    'demo.title': '演示模式',
    'demo.subtitle': '选择要体验的键盘布局',
    'demo.selectKeyboard': '选择键盘布局',
    'demo.selectDescription': '选择键盘布局以在演示模式下探索 Zellia Control 功能。',
    'demo.backToWelcome': '返回欢迎页面',
    'demo.keyboard60Description': '紧凑的 60% 布局，非常适合游戏和极简设置。',
    'demo.keyboard80Description': '无键盘布局，带有功能键，可实现平衡的生产力。',
    'demo.zellia60.title': 'Zellia 60HE',
    'demo.zellia60.description': '紧凑的 60% 布局，非常适合桌面空间有限的用户',
    'demo.zellia80.title': 'Zellia 80HE',
    'demo.zellia80.description': '带有功能键行的无键盘布局，实现全功能',
    'demo.continue': '继续演示',
    'demo.features.compact': '紧凑设计',
    'demo.features.fullFunction': '全功能键',
    'demo.features.hallEffect': '霍尔效应开关',
    'demo.features.keys': '按键',
