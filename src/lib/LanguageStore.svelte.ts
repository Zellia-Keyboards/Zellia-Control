...
export const translations = {
  en: {
    ...
    'calibration.calibrationActive': 'Calibration mode is active - Press keys to calibrate',
    'calibration.readyToCalibrate': 'Ready to calibrate - Click Start to begin',
    'calibration.clickStartButton': 'Click the Start Calibration button to enter calibration mode',
    'calibration.pressKeysStep': 'Press Physical Keys',
    'calibration.pressKeysDesc': 'Press each key you want to calibrate on the physical keyboard',
    'calibration.automaticDetection': 'Automatic Detection',
    'calibration.automaticDetectionDesc': 'Software automatically detects key presses and marks them as calibrated',
    'calibration.calibrationStatus': 'Calibration Status',
    'calibration.helpTitle': 'Calibration Help',
  ...
  zh: {
    ...
    'calibration.calibrationActive': '校准模式已激活 - 按键进行校准',
    'calibration.readyToCalibrate': '准备校准 - 点击开始按钮',
    'calibration.clickStartButton': '点击开始校准按钮进入校准模式',
    'calibration.pressKeysStep': '按下物理按键',
    'calibration.pressKeysDesc': '在物理键盘上按下每个要校准的按键',
    'calibration.automaticDetection': '自动检测',
    'calibration.automaticDetectionDesc': '软件自动检测按键按下并标记为已校准',
