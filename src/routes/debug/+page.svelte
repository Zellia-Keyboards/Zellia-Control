...
>
  ...
  <div class="rounded-xl shadow p-6 space-y-8 flex-1 border border-gray-200 dark:border-gray-600">
    ...
    >
      ...
      <button
        type="button"
        class="inline-block min-w-[120px] text-white border-none rounded-md px-4 py-2 font-semibold transition-colors duration-200 bg-primary-600 hover:bg-primary-500 hover:opacity-90"
