<script lang="ts">
  ...
  let { configuredDynamicKeys, KeyboardDisplayValues, resetAllDynamicKeys, onDeleteKey }: Props =
    $props();
    ...
    >
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {#each configuredDynamicKeys as [keyId, config]}
          ...
          <div
            class="group relative overflow-hidden transition-all duration-300 ease-out hover:shadow-lg hover:shadow-primary/10 {isDeleting
